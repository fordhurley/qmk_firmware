...
enum layers {
    ...
    SYMB, // symbols
    NMPD, // numpad
    GAME, // gameplay, no tap-hold so I can use wasd
};
...
[SYMB] = LAYOUT_ergodox_pretty(
  QK_BOOT, _______, _______, _______, _______,  _______, TG(GAME),     THMBSUP, _______, _______, _______, _______, _______, _______,
 ...
 * Keymap 3: Game Layer
 *
 * The only difference between this and the base layer is that the tap-hold
